...
import com.think.core.akka.ch02.akkademy.AkkademyDb.*;
import com.typesafe.config.ConfigFactory;

public class JClient {
	private final ActorSystem system = ActorSystem.create("LocalSystem", ConfigFactory.load("jclient.conf"), Thread.currentThread().getContextClassLoader());
