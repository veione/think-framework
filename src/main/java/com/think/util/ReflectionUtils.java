...
public class ReflectionUtils {
   ...
   * <code>name</code>. Searches all superclasses up to {@link Object}.
   * 
  ...
  /**
   * Attempt to find a {@link Field field} on the supplied {@link Class} with the supplied
   * <code>name</code> and/or {@link Class type}. Searches all superclasses up to {@link Object}.
   * 
   * @param clazz the class to introspect
  ...
  /**
   * Set the field represented by the supplied {@link Field field object} on the specified
   * {@link Object target object} to the specified <code>value</code>. In accordance with
   * {@link Field#set(Object, Object)} semantics, the new value is automatically unwrapped if the
   ...
   * such a root cause. Throws an IllegalStateException with an appropriate message else.
   * 
   ...
   * checked exception is expected to be thrown by the target method.
   * <p>
   * Rethrows the underlying exception cast to an {@link Exception} or {@link Error} if appropriate;
