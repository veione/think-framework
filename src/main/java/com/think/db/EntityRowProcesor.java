 ...
 * @see RowProcessor
 */
public class EntityRowProcesor implements RowProcessor {

    /**
     * The default BeanProcessor instance to use if not supplied in the
     * constructor.
     */
    private static final EntityProcessor defaultConvert = new EntityProcessor();

    /**
     * The Singleton instance of this class.
     */
    private static final org.apache.commons.dbutils.BasicRowProcessor instance = new org.apache.commons.dbutils.BasicRowProcessor();
     ...
     */
    @Deprecated
    public static org.apache.commons.dbutils.BasicRowProcessor instance() {
        return instance;
    }
     ...
     * @since DbUtils 1.1
     */
    public EntityRowProcesor(EntityProcessor convert) {
        super();
    ...
    public Map<String, Object> toMap(ResultSet rs) throws SQLException {
        Map<String, Object> result = new EntityRowProcesor.CaseInsensitiveHashMap();
