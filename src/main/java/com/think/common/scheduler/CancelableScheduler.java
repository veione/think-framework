...
/**
 * @author netty-socketio
 * @see {https://github.com/veione/netty-socketio/blob/master/src/main/java/com/corundumstudio/socketio/scheduler/CancelableScheduler.java
 */
